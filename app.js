...
function calcTaperReverse() {
  ...
  showResult('taper-rev-result-box');
}


/* ===== CALC 4: SURFACE ROUGHNESS ===== */
// Table data from Image 4 (Werden chart)
const roughnessData = [
...
function calcFeed() {
  ...
  showResult('cut-feed-box');
}


/* ===== CALC: METRIC THREAD DRILL ===== */
// Standard metric thread table [d, pitch_coarse, d1, d2]
const metricThreads = [
  [1,   0.25, 0.693, 0.838],
